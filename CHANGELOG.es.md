...
- Ahora la versión de la web tiene su propio identificador de aplicación y su propia unidad de banner, de modo que los anuncios de ambas versiones se pueden medir y diagnosticar por separado.
...
- Un código de error de Firebase que no reconocemos añadía una frase en inglés de la librería al mensaje en tu idioma. En ese caso poco frecuente ahora ves una frase en el idioma elegido y el detalle técnico queda en el registro.
...
- Nota: desde esta versión el número de versión coincide con el número de compilación (63 = 1.0.63). Antes diferían en uno.
