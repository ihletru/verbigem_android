...
- ⚠️ **Sampler: greedy — celowo, nie z braku wiedzy.** Tencent zaleca `temp 0.7 / top_p 0.6 / top_k 20 / rep 1.05`. Zmierzyliśmy A/B na urządzeniu: **na Q4_K_M zero różnicy** (3 z 4 zdań identyczne — `top_k 20 + top_p 0.6` to i tak prawie greedy), a na 1.25-bit sampling dał 2 poprawki *i* 1 błąd gramatyczny. Greedy zostaje, bo jest **deterministyczny**: to samo zdanie daje ten sam wynik przy ponownym tłumaczeniu. Szczegóły `docs/SILNIK_PRO_RESEARCH.md` §10.
